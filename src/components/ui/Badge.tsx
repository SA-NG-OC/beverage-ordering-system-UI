...
export function OrderStatusBadge({ status }: { status: OrderStatus }) {
  const config: Record<OrderStatus, { label: string; variant: "warning" | "info" | "success" | "danger" }> = {
...
export function ProductStatusBadge({ status }: { status: ProductStatus }) {
  const config: Record<ProductStatus, { label: string; variant: "success" | "neutral" | "danger" }> = {
