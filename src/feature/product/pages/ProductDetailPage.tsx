...
export function ProductDetailPage() {
    ...
    if (isLoading) {
        return (<div className="max-w-4xl mx-auto p-6 bg-white rounded-2xl shadow-sm border border-gray-100 animate-pulse space-y-6">
    ...
    if (error || !product) {
        return (<div className="max-w-4xl mx-auto p-8 bg-white rounded-2xl border border-gray-100 text-center space-y-4">
            <span className="text-4xl">🍹</span>
            <h2 className="text-xl font-bold text-gray-900">Product Not Found</h2>
            <p className="text-sm text-gray-500">{error || "The product you are looking for does not exist."}</p>
