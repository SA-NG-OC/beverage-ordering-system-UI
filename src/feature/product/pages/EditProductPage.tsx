...
import type { ProductStatus, UpdateProductDto } from "@/types/product.type";
    ...
    if (fetchError || !product) {
        return (
            <div className="max-w-2xl mx-auto p-8 bg-white rounded-2xl border border-gray-100 text-center space-y-4">
                ...
                <p className="text-sm text-gray-500">{fetchError || "Unable to load product for editing."}</p>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 space-y-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Update beverage details, pricing, and availability status.</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                {...register("status")}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 text-sm bg-white"
                            >
