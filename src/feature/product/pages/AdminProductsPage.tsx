...
export function AdminProductsPage() {
    const {
        ...
        page,
        setPage,
    } = useProducts({ initialLimit: 88, isPublic: false });
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-3">
                    ...
                    <select
                        ...
                        className="w-full sm:w-auto px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-200"
                    >
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12 bg-white rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <p className="text-sm text-gray-500">Try adjusting your search keywords or filter status.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
